...
class Pneumology extends StatefulWidget {
  const Pneumology({super.key});

  @override
  State<Pneumology> createState() => _PneumologyState();
}

class _PneumologyState extends State<Pneumology> {
  ...
  Future<int> fetchGeneralDoctorsCount() async {
    var querySnapshot = await FirebaseFirestore.instance
        .collection('doctors')
        .where('field', isEqualTo: 'Pneumologue')
        .get();
                        ...
                        child: Center(
                          child: SizedBox(
                            ...
                            child: SvgPicture.asset(
                              'assets/images/search/breath.svg',
                              fit: BoxFit.contain,
                            ),
                          ),
                        ),
