...
class Orthopedy extends StatefulWidget {
  const Orthopedy({super.key});

  @override
  State<Orthopedy> createState() => _OrthopedyState();
}

class _OrthopedyState extends State<Orthopedy> {
  ...
  Future<int> fetchGeneralDoctorsCount() async {
    var querySnapshot = await FirebaseFirestore.instance
        .collection('doctors')
        .where('field', isEqualTo: 'Orthopédiste')
        .get();
                        ...
                        child: Center(
                          child: SizedBox(
                            ...
                            child: SvgPicture.asset(
                              'assets/images/search/fracture.svg',
                              fit: BoxFit.contain,
                            ),
                          ),
                        ),
