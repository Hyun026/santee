...
class Ophtal extends StatefulWidget {
  const Ophtal({super.key});

  @override
  State<Ophtal> createState() => _OphtalState();
}

class _OphtalState extends State<Ophtal> {
  ...
  Future<int> fetchGeneralDoctorsCount() async {
    var querySnapshot = await FirebaseFirestore.instance
        .collection('doctors')
        .where('field', isEqualTo: 'Ophtalmologiste')
        .get();
