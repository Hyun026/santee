...
class Pediatrie extends StatefulWidget {
  const Pediatrie({super.key});

  @override
  State<Pediatrie> createState() => _PediatrieState();
}

class _PediatrieState extends State<Pediatrie> {
  ...
  Future<int> fetchGeneralDoctorsCount() async {
    var querySnapshot = await FirebaseFirestore.instance
        .collection('doctors')
        .where('field', isEqualTo: 'Pédiatrie')
        .get();
                        ...
                        child: Center(
                          child: SizedBox(
                            ...
                            child: SvgPicture.asset(
                              'assets/images/search/baby-boy.svg',
                              fit: BoxFit.contain,
                            ),
                          ),
                        ),
